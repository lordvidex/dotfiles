return {
  ...
  keys = {
    ...
    { "<leader>hd", "<cmd>lua require('harpoon.mark').rm_file()<CR>",         desc = "Harpoon Remove file" },
    { "<leader>hh", "<cmd>lua require('harpoon.ui').toggle_quick_menu()<CR>", desc = "Harpoon [M]enu" },
