return {
  ...
  config = function()
    ...
    local global_mappings = {
      ...
      { "<leader>l",  group = "LSP",                                                           nowait = true,                       remap = false,  buffer = true },
      -- { "<leader>la", "<cmd>Lspsaga code_action<CR>",                                          mode = { "n", "v" },                 buffer = true,  silent = true, noremap = true },
      ...
      -- { "gD",         "<cmd>lua vim.lsp.buf.declaration()<CR>",                                noremap = true,                      silent = true,  buffer = true },
      -- { "gd",         "<cmd>Lspsaga goto_definition<CR>",                                      noremap = true,                      silent = true,  buffer = true },
      -- { "gp",         "<cmd>Lspsaga peek_definition<CR>",                                      noremap = true,                      silent = true,  buffer = true },
      -- { "gi",         "<cmd>lua vim.lsp.buf.implementation()<CR>",                             noremap = true,                      silent = true,  buffer = true },
      -- { "gh",         "<cmd>Lspsaga finder<CR>",                                               noremap = true,                      silent = true,  buffer = true },
      -- { "K",          "<cmd>Lspsaga hover_doc<CR>",                                            noremap = true,                      silent = true,  buffer = true },
      -- { "[e",         "<cmd>Lspsaga diagnostic_jump_prev<CR>",                                 noremap = true,                      silent = true,  buffer = true },
      -- { "]e",         "<cmd>Lspsaga diagnostic_jump_next<CR>",                                 noremap = true,                      silent = true,  buffer = true },
      -- { "<C-q>",      "<cmd>lua vim.lsp.buf.signature_help()<CR>",                             noremap = true,                      silent = true,  buffer = true },
      -- { "gr",         "<cmd>lua vim.lsp.buf.references()<CR>",                                 noremap = true,                      silent = true,  buffer = true },
      -- { "gt",         "<cmd>Lspsaga peek_type_definition<CR>",                                 noremap = true,                      silent = true,  buffer = true },
      -- { "[E", function()
